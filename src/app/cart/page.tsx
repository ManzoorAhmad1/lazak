...
import { HiTrash, HiPlus, HiMinus, HiShoppingBag, HiArrowRight, HiShieldCheck, HiTruck } from 'react-icons/hi2';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cart.map((item, idx) => (
              ...
              >
              <Card className="p-4 sm:p-6 flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    >
                      <HiTrash className="w-4 h-4 mr-2" /> Remove
                    </Button>
                  </div>
                </div>
              </Card>
          ...
          >
            <Card className="p-8 space-y-6">
              ...
              <Button className="w-full gap-2" size="lg">
                Checkout Now <HiArrowRight className="w-4 h-4" />
              </Button>
              
              <div className="space-y-3 pt-4">
                <div className="flex items-center gap-2 text-xs text-text-muted">
                  <HiShieldCheck className="w-4 h-4 text-green-500" /> Secure checkout powered by Stripe
                </div>
                <div className="flex items-center gap-2 text-xs text-text-muted">
                  <HiTruck className="w-4 h-4 text-primary" /> Free express shipping included
                </div>
              </div>
            </Card>
          </motion.div>
