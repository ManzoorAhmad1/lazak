...
import { HiChevronRight, HiHome, HiShoppingBag } from 'react-icons/hi2';
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-text-muted max-w-2xl">Browse our premium selection of {category.name.toLowerCase()} meticulously curated for quality and performance.</p>
          </div>
        </motion.div>
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-20 space-y-4 bg-surface rounded-3xl border border-muted/10">
            <HiShoppingBag className="w-16 h-16 text-muted/20 mx-auto" />
            ...
            <Link href="/products"><Button>Explore All Products</Button></Link>
          </div>
        )}
      </div>
    </main>
